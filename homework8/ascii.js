...
// variable to keep the content before the starting the animation
var valueBeforeAnimation;
// variable keeping the setInterval method
var interval;
// timer to change when the checkbox speed is checked
var timer = 250;
